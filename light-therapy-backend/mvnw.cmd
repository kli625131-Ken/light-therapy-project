...
if not "%MAVEN_SKIP_RC%"=="on" (call "%USERPROFILE%\mavenrc_pre.bat" 2>nul)
...
@REM execute user defined script after this one
if not "%MAVEN_SKIP_RC%"=="on" (call "%USERPROFILE%\mavenrc_post.bat" 2>nul)

@REM set environment variables for post scripts
