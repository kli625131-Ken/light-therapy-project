...
export const listTreatments = (subjectId = null, status = null, startDate = null, endDate = null, page = 0, pageSize = 10) => http.get('/api/treatments', { params: { subjectId, status, startDate, endDate, page, size: pageSize } })

export const getTreatment = (id) => http.get(`/api/treatments/${id}`)

export const getTreatmentbySubject = (id, status = null, startDate = null, endDate = null, page = 0, pageSize = 10) => http.get(`/api/treatments/subject/${id}`, { params: { status, startDate, endDate, page, size: pageSize } })
